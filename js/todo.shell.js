    ...
    + '</div>'
     ...
     +'</div>'
      + '<div class="row">'
        ...
        + '</div>'
      + '</div>'
      +'<div class="footer"><p>TODO APP made by <a  target="_blank" href="http://www.linkedin.com/in/marekpyczkowski">Marek Pyczkowski</a> with <a target="_blank" href="https://github.com/clarkr/nextcapital-todo"> NextCapital API</a> </p></div>'
    },
    stateMap = {
      $container: null
    },
